...
const Navigation = () => {
    ...
    const handleCreate = () => {
        const promice = create({ title: "Untitled" });
  ...
  return (
    ...
    isResetting && "transition-all ease-in-out duration-300", isMobile && "w-0"
        ...
        <div role='button'
        onClick={collapse}
        className={cn('h-6 w-6 text-muted-foreground rouned-sm hover:bg-neutral-300 dark:hover:bg-neutral-600 absolute top-3 right-2 opacity-0 group-hover/sidebar:opacity-100 transition',
